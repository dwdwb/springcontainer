...
import com.mycompany.springcontainer.dto.Ch03Dto;
...
public class Ch03Controller {
   ...
   public String method2(
		   ...
		   @RequestParam(value="param3", defaultValue="0.0") double param3, 
		   @RequestParam(value="param4", defaultValue="false") boolean param4, 
		   @DateTimeFormat(pattern="yyyy-MM-dd") Date param5) {
