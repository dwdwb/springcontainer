...
import com.mycompany.springcontainer.dto.Ch08Item;
import com.mycompany.springcontainer.dto.Ch08Member;
import com.mycompany.springcontainer.dto.Login;
...
public class Ch08Controller {
	...
	public String login(Ch08Member member, HttpSession session) {
		if(member.getMpassword().equals("12345")) {
			...
			member.setMaddress("서울특별시 종로구 혜화동");
	...
	public String clearCart(HttpSession session) {
		...
		//방법2: 세션 자체를 무료화(세선에 저장된 모든 정보가 없어짐)
